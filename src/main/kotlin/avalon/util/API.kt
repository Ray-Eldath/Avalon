...
class PluginInfo(val name: String, val version: String, val copyright: String, val website: String, val classString: String, val fileName: String, val isEnabled: Boolean)
