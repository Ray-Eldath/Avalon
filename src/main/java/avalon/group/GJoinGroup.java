...
public class GJoinGroup extends BaseGameResponder {
    ...
    public void doPost(GroupMessage message) {
        ...
        if (Pattern.matches("game group join \\d+", content)) {
            int id = Integer.parseInt(content.replace("game avalon.group join ", ""));
            ...
            String groupName = content.replace("game avalon.group join ", "");
    ...
    public String getGameHelpMessage() {
        return "game avalon.group join <小组ID/小组名>：加入小组";
    }
}
